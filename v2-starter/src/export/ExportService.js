...
const DOC_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  footer { margin-top:32px; padding-top:14px; border-top:1px solid #e3ecf2; font-size:11px; color:#8398a3; }
...
export class ExportService {
  ...
  _buildResiliencePlanDoc(plan, context) {
    ...
    const body = `
      ...
      ${viability.justification ? `<h2>Viability</h2><p>${escapeHtml(viability.justification)}</p>` : ''}
    `;
...
<body>
  <div class="doc">
    ...
    <main>${body}</main>
    <footer>
      Estimates are grounded in CMIP6 SSP projections and comparable resilience-project data.
      Generated by a simulation tool — not financial, legal, or engineering advice.
    </footer>
  </div>
</body>
</html>`;
